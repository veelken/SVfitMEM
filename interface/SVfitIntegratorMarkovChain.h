#ifndef TauAnalysis_SVfitStandalone_SVfitIntegratorMarkovChain_h
#define TauAnalysis_SVfitStandalone_SVfitIntegratorMarkovChain_h
...
namespace svFitMEM
{
  class SVfitIntegratorMarkovChain : public SVfitIntegratorBase
  {
   public:
