#ifndef TauAnalysis_SVfitMEM_HttXsectionIntegrandWithTauDecays_nlo_h
#define TauAnalysis_SVfitMEM_HttXsectionIntegrandWithTauDecays_nlo_h
...
class HttXsectionIntegrandWithTauDecays_nlo
{
 public:
  HttXsectionIntegrandWithTauDecays_nlo(double, double, const std::string&, int);
  ~HttXsectionIntegrandWithTauDecays_nlo();
  ...
  static const HttXsectionIntegrandWithTauDecays_nlo* gHttXsectionIntegrandWithTauDecays;
 ...
 protected:
  ...
  mutable svFitMEM::LorentzVector parton1P4_incoming_;
  mutable svFitMEM::LorentzVector parton2P4_incoming_;
  mutable svFitMEM::LorentzVector tau1P4_outgoing_;
  mutable svFitMEM::LorentzVector tau2P4_outgoing_;
  mutable svFitMEM::LorentzVector jetP4_outgoing_;
  mutable std::vector<const svFitMEM::LorentzVector*> momenta_;
