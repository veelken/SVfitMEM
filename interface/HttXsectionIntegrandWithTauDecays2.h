#ifndef TauAnalysis_SVfitMEM_HttXsectionIntegrandWithTauDecays2_h
#define TauAnalysis_SVfitMEM_HttXsectionIntegrandWithTauDecays2_h
...
class HttXsectionIntegrandWithTauDecays2 
{
 public:
  HttXsectionIntegrandWithTauDecays2(double, double, const std::string&, int, const std::string&, int);
  ~HttXsectionIntegrandWithTauDecays2();
  ...
  {
    //std::cout << "<HttXsectionIntegrandWithTauDecays2::enableAcceptanceCuts>: acceptance = " << &acceptance << std::endl;
    acceptance_ = &acceptance;      
  }
  void disableAcceptanceCuts()
  {
    //std::cout << "<HttXsectionIntegrandWithTauDecays2::disableAcceptanceCuts>:" << std::endl;
    acceptance_ = 0;
  }
  ...
  void setApplyZeroPtConstraint(bool applyZeroPtConstraint) { applyZeroPtConstraint_ = applyZeroPtConstraint; }  
  ...
  static const HttXsectionIntegrandWithTauDecays2* gHttXsectionIntegrandWithTauDecays;
