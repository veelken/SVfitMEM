#ifndef TauAnalysis_SVfitMEM_HttXsectionWithTauDecays_nlo_h
#define TauAnalysis_SVfitMEM_HttXsectionWithTauDecays_nlo_h
...
class HttXsectionWithTauDecays_nlo
{
 public:
  HttXsectionWithTauDecays_nlo(double, double, const std::string&, int = 0); 
  ~HttXsectionWithTauDecays_nlo();
 ...
 protected:
  ...
  HttXsectionIntegrandWithTauDecays_nlo* integrand_;
  double sqrtS_;
  double mH_;
  double mH2_;
