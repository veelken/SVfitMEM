#ifndef TauAnalysis_SVfitMEM_SVfitMEM_nlo_h
#define TauAnalysis_SVfitMEM_SVfitMEM_nlo_h
...
{
 public:
  SVfitMEM_nlo(double, const std::string&, int = 0); 
  ~SVfitMEM_nlo();
  ...
  {
    integrand_->enableAcceptanceCuts(minLeg1Pt, maxLeg1AbsEta, minLeg2Pt, maxLeg2AbsEta);
  }
  ...
  /// run integration 
  void integrate(const std::vector<svFitMEM::MeasuredTauLepton>&, double, double, double, const TMatrixD&, const std::string& = "");
 ...
 protected:
  ...
  svFitMEM::SVfitIntegrand_nlo* integrand_;
  double sqrtS_;
