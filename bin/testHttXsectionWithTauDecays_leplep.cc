...
double acceptanceLepLep(const svFitMEM::LorentzVector& visTau1P4, const svFitMEM::LorentzVector& visTau2P4, double metPx, double metPy)
{
  //std::cout << "<acceptanceLepLep>:" << std::endl;
  ...
  double acceptance = 0.;
  if ( ((visTau1P4.pt() > 20. && visTau2P4.pt() > 10.) || 
	(visTau1P4.pt() > 10. && visTau2P4.pt() > 20.)) &&
	TMath::Abs(visTau1P4.eta()) < 2.4 && TMath::Abs(visTau2P4.eta()) < 2.4 ) {
