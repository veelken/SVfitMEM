...
me_ggH_lo_mg5::me_ggH_lo_mg5(bool applyNWA, bool includeHtoTauTauDecay)
  : applyNWA_(applyNWA),
...
void me_ggH_lo_mg5::initProc(const string& param_card_name) 
{
...
void me_ggH_lo_mg5::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double me_ggH_lo_mg5::matrix_gg_h_h_tamtap() 
{
  int i, j; 
  // Local variables
  //const int ngraphs = 1; 
