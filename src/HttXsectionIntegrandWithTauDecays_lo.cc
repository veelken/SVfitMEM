...
const HttXsectionIntegrandWithTauDecays_lo* HttXsectionIntegrandWithTauDecays_lo::gHttXsectionIntegrandWithTauDecays = 0;
int HttXsectionIntegrandWithTauDecays_lo::gNumInstances = 0;

HttXsectionIntegrandWithTauDecays_lo::HttXsectionIntegrandWithTauDecays_lo(double sqrtS, double mH, const std::string& pdfName, int mode, const std::string& madgraphFileName, int verbosity) 
  : mode_(mode),
    applyMEtTF_(true),    
    mH_(mH),
    mH2_(mH*mH),
...
{
  if ( verbosity_ ) {
    std::cout << "<HttXsectionIntegrandWithTauDecays_lo::HttXsectionIntegrandWithTauDecays_lo>:" << std::endl;
  }
  ...
  if ( madgraphFileName != "" ) {
    ...
    std::cerr << "Error in <HttXsectionIntegrandWithTauDecays_lo>: No param.dat file for Madgraph given !!" << std::endl;
    assert(0);
  }
  if ( mode_ == kMadgraph ) {
...
HttXsectionIntegrandWithTauDecays_lo::~HttXsectionIntegrandWithTauDecays_lo()
{
  std::cout << "<HttXsectionIntegrandWithTauDecays_lo::~HttXsectionIntegrandWithTauDecays_lo>:" << std::endl;
  delete pdf_;
  ...
  outputFileName_ = Form("HttXsectionIntegrandWithTauDecays_lo_mH%03.0f", mH_);
...
void HttXsectionIntegrandWithTauDecays_lo::updateNumDimensions()
{
  numDimensions_ = -1;
...
void 
HttXsectionIntegrandWithTauDecays_lo::setInputs(int tau1Type, double vis1Mass, int tau2Type, double vis2Mass, const TMatrixD& covMET)
{
  if ( verbosity_ ) {
    std::cout << "<HttXsectionIntegrandWithTauDecays_lo::setInputs>:" << std::endl;
  }
...
double
HttXsectionIntegrandWithTauDecays_lo::Eval(const double* x) const 
{
  if ( verbosity_ >= 2 ) {
    std::cout << "<HttXsectionIntegrandWithTauDecays_lo::Eval(const double*)>:" << std::endl;
...
double
HttXsectionIntegrandWithTauDecays_lo::compProb(const double* x, const LorentzVector& vis1P4, double x1, const LorentzVector& vis2P4, double x2, double absDgDp2z) const
{
